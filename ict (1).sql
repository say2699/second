...
--
-- Хост: localhost
-- Время создания: Окт 30 2018 г., 16:30
...
('root', '[{"db":"ict","table":"education_experiences"},{"db":"ict","table":"job_experiences"},{"db":"ict","table":"companies"},{"db":"ict","table":"vfeedbacks"},{"db":"ict","table":"vacancies"},{"db":"ict","table":"users"},{"db":"ict","table":"resumes"}]');
